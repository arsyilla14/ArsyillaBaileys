    ...
    switch (item.syncType) {
        ...
        case WAProto_1.proto.HistorySync.HistorySyncType.ON_DEMAND:
            for (const chat of item.conversations) {
                contacts.push({ id: chat.id, name: chat.name || undefined, lid: chat.lidJid || undefined, jid: (0, WABinary_1.isPnUser)(chat.id) ? chat.id : chat.pnJid });
                ...
                if ((0, WABinary_1.isPnUser)(chat.id) && chat.readOnly && chat.archived) {
